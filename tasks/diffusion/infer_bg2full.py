...
with torch.no_grad():
    prompt = "A man in a red-and-black hooded jacket stands on a misty urban rooftop at dawn, gazing over the city skyline. His white collar peeks out as wind ruffles his short brown hair against the cool morning air."
    image1 = Image.open("./inputs/background_example.png").convert("RGBA")
    ...
    if outputs:
        save_path = "outputs/output_bg2full.png"
